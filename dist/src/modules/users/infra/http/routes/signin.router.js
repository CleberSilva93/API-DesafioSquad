...
var signin = express_1.Router();
signin.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, senha, authenticateUser, _b, user, token, err_1;
