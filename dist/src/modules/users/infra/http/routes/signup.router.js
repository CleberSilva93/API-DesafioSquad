...
var signup = express_1.Router();
signup.post('/', celebrate_1.celebrate((_a = {},
    ...
    _a)), function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, nome, senha, email, telefone, users, user, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = request.body, nome = _a.nome, senha = _a.senha, email = _a.email, telefone = _a.telefone;
                users = new CreateUser_1.default();
                return [4 /*yield*/, users.execute({
                        nome: nome,
                        email: email,
                        telefone: telefone,
                        senha: senha,
