...
var CreateUser = /** @class */ (function () {
    ...
    CreateUser.prototype.execute = function (_a) {
        var nome = _a.nome, senha = _a.senha, email = _a.email, telefone = _a.telefone;
        return __awaiter(this, void 0, void 0, function () {
            var checkUserExists, hashSenha, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.users.findByEmail(email)];
                    case 1:
                        checkUserExists = _b.sent();
                        if (checkUserExists) {
                            throw new AppError_1.default('E=mail já existente.');
                        }
